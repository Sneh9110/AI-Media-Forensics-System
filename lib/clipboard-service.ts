...
export function formatAnalysisAsText(result: AnalysisResultText): string {
  const predictionEmoji = result.prediction === 'synthetic' ? '⚠️' : '✅'
...
FORENSIC SCORES
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
🔍 Spatial Score:            ${(result.spatialScore * 100).toFixed(2)}%
📊 Frequency Score:          ${(result.frequencyScore * 100).toFixed(2)}%
🤖 AI Generation Score:      ${(result.aiGenerationScore * 100).toFixed(2)}%
🎭 Deepfake Score:           ${(result.deepfakeScore * 100).toFixed(2)}%
✂️  Manipulation Score:        ${(result.manipulationScore * 100).toFixed(2)}%
📷 PRNU Sensor Score:        ${(result.prnuSensorScore * 100).toFixed(2)}%
...
Confidence: ${confidencePercent}% - Recommend manual review for critical decisions.`
    : `✅ HIGH PROBABILITY OF AUTHENTIC CONTENT
